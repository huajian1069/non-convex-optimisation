...
Test on frist objective function: Ackley with $$a = 20, b = 0.2, d = 2, c = 2 \pi$$   $$ f(x) = -a exp\left{-b\sqrt{ \frac{1}{d} \sum_{i=1}^{d} x_i^2 }\right} - exp\left{ \frac{1}{d} \sum_{i=1}^{d} \cos\left(c x_i \right) \right} + a + e$$
